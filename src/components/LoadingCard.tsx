...
export const LoadingCard = () => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-[#1C1C1E]/80 backdrop-blur-sm">
      <Card className="w-[300px] h-[300px] p-8 bg-[#2C2C2E]/80 backdrop-blur-xl rounded-3xl border-0">
