...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex w-full items-center justify-center rounded-2xl bg-[#2C2C2E]/50 backdrop-blur-lg p-1.5",
      className
    )}
    {...props}
  />
